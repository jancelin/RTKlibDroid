...
client_socket.connect(('82.64.252.223', 5000))
        ...
        for line in lines:
          ...
          if key in dict:
             ...
             if dict['solution status'] == 'single':
                 ...
                 print('sde:' + POS_XYZ_Float_Std_X)
                 print('sdn:' + POS_XYZ_Float_Std_Y)
                 print('sdu:' + POS_XYZ_Float_Std_Z)
             elif dict['solution status'] == 'fix':
                 print('sde:' + POS_XYZ_Fixed_Std_X)
                 print('sdn:' + POS_XYZ_Fixed_Std_Y)
                 print('sdu:' + POS_XYZ_Fixed_Std_Z)
             else:
                 print("no signal")
